    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MainActivity.this, "Please enter your email address in the email field!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    String email = etMail.getText().toString().trim();
                    ...
                    Backendless.UserService.restorePassword(email, new AsyncCallback<Void>() {
                        ...
                        public void handleResponse(Void response) {
                            ...
                            Toast.makeText(MainActivity.this, "Reset instructions sent to email address!", Toast.LENGTH_SHORT).show();
                            showProgress(false);
                        }
